...
ALTER TABLE DISTRITO ADD CONSTRAINT FK_DISTRITO_PROVINCIA
    ...
    REFERENCES PROVINCIA (nombre_pais, nombre_provincia)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;

-- Reference: FK_EVENTO_DISTRITO (table: EVENTO)
ALTER TABLE EVENTO ADD CONSTRAINT FK_EVENTO_DISTRITO
...
ALTER TABLE EVENTO_EDICION ADD CONSTRAINT FK_EVENTO_EDICION_EVENTO
...
ALTER TABLE EVENTO ADD CONSTRAINT FK_EVENTO_SUBCATEGORIA
    FOREIGN KEY (id_categoria, id_subcategoria)
    REFERENCES SUBCATEGORIA (id_categoria, id_subcategoria)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;
...
ALTER TABLE PATROCINIOS ADD CONSTRAINT FK_PATROCIONIOS_EVENTO_EDICION
    FOREIGN KEY (id_evento, nro_edicion)
    REFERENCES EVENTO_EDICION (id_evento, nro_edicion)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;

-- Reference: FK_PATROCIONIOS_PATROCINANTE (table: PATROCINIOS)
ALTER TABLE PATROCINIOS ADD CONSTRAINT FK_PATROCIONIOS_PATROCINANTE
    FOREIGN KEY (id_patrocinate)
    REFERENCES PATROCINANTE (id_patrocinate)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;
...
ALTER TABLE PATROCINANTE ADD CONSTRAINT PATROCINANTE_DISTRITO
    FOREIGN KEY (id_distrito)
    REFERENCES DISTRITO (id_distrito)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
