...
CREATE TABLE GR21_PATROCINANTE (
    ...
    id_distrito int  NOT NULL,
    CONSTRAINT PK_GR21_PATROCINANTE PRIMARY KEY (id_patrocinate)
);
...
CREATE TABLE GR21_PATROCINIOS (
    ...
    CONSTRAINT PK_GR21_PATROCINIOS PRIMARY KEY (id_patrocinate,id_evento,nro_edicion)
);
...
ALTER TABLE G21_DISTRITO ADD CONSTRAINT FK_GR21_DISTRITO_PROVINCIA
...
ALTER TABLE G21_EVENTO ADD CONSTRAINT FK_GR21_EVENTO_DISTRITO
...
ALTER TABLE G21_EVENTO_EDICION ADD CONSTRAINT FK_GR21_EVENTO_EDICION_EVENTO
...
ALTER TABLE GR21_PATROCINIOS ADD CONSTRAINT FK_GR21_PATROCIONIOS_PATROCINANTE
    ...
    REFERENCES GR21_PATROCINANTE (id_patrocinate)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
;
